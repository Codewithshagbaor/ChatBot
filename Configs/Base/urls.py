...
urlpatterns = [
    path('', views.inndex, name="inndex"),
    path('chat/', views.index, name="index"),
    path('login/', admin_view.login_view, name="login"),
    path('logout/', admin_view.logout_view, name="logout_view"),
    ...
    path('dashboard/m/<str:room_uid>/reply/', admin_view.chat_room_reply, name='chat_room_reply'),
    path('c/<str:room_uid>/', views.chat_room, name='chat_room'),
